          ...
          <div className="col-md-3">
            ...
            <div className="box box-warning direct-chat direct-chat-warning">
              <div className="box-header with-border">
                ...
                <div className="box-tools pull-right">
                  <span
                    data-toggle="tooltip" title="3 New Messages" className="badge bg-yellow"
                  >3</span>
                  <button type="button" className="btn btn-box-tool" data-widget="collapse">
                    <i className="fa fa-minus" />
                  </button>
          ...
          <div className="col-md-3">
            ...
            <div className="box box-danger direct-chat direct-chat-danger">
              <div className="box-header with-border">
                ...
                <div className="box-tools pull-right">
                  <span
                    data-toggle="tooltip" title="3 New Messages" className="badge bg-red"
                  >3</span>
                  <button type="button" className="btn btn-box-tool" data-widget="collapse">
                    <i className="fa fa-minus" />
                  </button>
        ...
        <div className="row">
              ...
              <div className="box-footer no-padding">
                <ul className="nav nav-stacked">
                  <li>
                    <Link to="#">
                      Projects
                      <span className="pull-right badge bg-blue">31</span>
                    </Link>
                  </li>
                  <li>
                    <Link to="#">
                  ...
                  <li>
                    <Link to="#">
                      Completed Projects
                      <span className="pull-right badge bg-green">12</span>
                    </Link>
                  </li>
                  <li>
                    <Link to="#">
                      Followers
                      <span className="pull-right badge bg-red">842</span>
                    </Link>
                  </li>
                </ul>
              </div>
          ...
          <div className="col-md-4">
            ...
            <div className="box box-widget widget-user">
              {/* Add the bg color to the header using any of the bg-* classes */}
              <div
                className="widget-user-header bg-black" style={{
            ...
            <div className="box box-widget">
              ...
              <div className="box-body">
                <img
                  ...
                  src="/AdminLTE/dist/img/photo2.png"
                  alt="morning"
                />
                <p>
              ...
              <div className="box-body">
                ...
                <div className="attachment-block clearfix">
                  <img
                    ...
                    src="/AdminLTE/dist/img/photo1.png"
                    alt="Attachment"
                  />
                  <div className="attachment-pushed">
                    <h4 className="attachment-heading">
                      <Link to="http://www.lipsum.com/">
