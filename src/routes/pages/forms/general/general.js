              ...
              <div className="box-body">
                <form role="form">
                  ...
                  <div className="form-group has-success">
                    <label className="control-label" htmlFor="inputSuccess"><i className="fa fa-check"/> Input with
                      success</label>
                  ...
                  <div className="form-group has-error">
                    <label className="control-label" htmlFor="inputError"><i className="fa fa-times-circle-o"/> Input
                      with
                      error</label>
