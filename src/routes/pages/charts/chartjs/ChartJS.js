    ...
    $(() => {
      ...
      */
      ...
      const areaChartOptions = {
        ...
        legendTemplate: '<ul class="<%=name.toLowerCase()%>-legend"><% for (let i=0; i<datasets.length; i++){%><li><span style="background-color:<%=datasets[i].lineColor%>"></span><%if(datasets[i].label){%><%=datasets[i].label%><%}%></li><%}%></ul>', // eslint-disable-line max-len
      ...
      areaChart.Line(areaChartData, areaChartOptions); // eslint-disable-line new-cap
      ...
      lineChart.Line(areaChartData, lineChartOptions); // eslint-disable-line new-cap
      ...
      const pieOptions = {
        ...
        maintainAspectRatio: true,
        // String - A legend template
        legendTemplate: '<ul class="<%=name.toLowerCase()%>-legend"><% for (let i=0; i<segments.length; i++){%><li><span style="background-color:<%=segments[i].fillColor%>"></span><%if(segments[i].label){%><%=segments[i].label%><%}%></li><%}%></ul>', // eslint-disable-line max-len
      };
      ...
      const barChartOptions = {
        ...
        barDatasetSpacing: 1,
        // String - A legend template
        legendTemplate: '<ul class="<%=name.toLowerCase()%>-legend"><% for (let i=0; i<datasets.length; i++){%><li><span style="background-color:<%=datasets[i].fillColor%>"></span><%if(datasets[i].label){%><%=datasets[i].label%><%}%></li><%}%></ul>', // eslint-disable-line max-len
      ...
      barChart.Bar(barChartData, barChartOptions); // eslint-disable-line new-cap
    });
  }
...
export default withStyles(s)(ChartJS);
